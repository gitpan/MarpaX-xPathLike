...
=head2 MarpaX::xPathLike methods
...
Send email to C<< <jvverde at gmail.com> >> with subject MarpaX::xPathLike
or report any bugs or feature requests to C<bug-data-xPathLike at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=MarpaX-xPathLike>.  I will be notified, and then you'll
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=MarpaX-xPathLike>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/MarpaX-xPathLike>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/MarpaX-xPathLike>

=item * Search CPAN

L<http://search.cpan.org/dist/MarpaX-xPathLike/>
